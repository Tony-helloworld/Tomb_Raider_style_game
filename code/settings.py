...
# weapons 
weapon_data = {
    'gun': {'cooldown': 20, 'damage': 0, 'graphic': '../graphics/weapons/gun/full.png'},
...
# item
item_data = {
    'gold': {'graphic': '../graphics/coins/gold/0.png', 'recovery': 20},
    'silver': {'graphic': '../graphics/coins/silver/0.png', 'recovery': 10},
    'bullet': {'graphic': '../graphics/coins/bullet/bullet_up.png', 'recovery': 0, 'damage': 100},
}

# trap
trap_data = {
    'throny': {'damage': 10, 'speed': 0, 'graphic': '../graphics/trap/throny.png', 'attack_type': 'health'},
    'spy_net': {'damage': 0, 'speed': 2, 'graphic': '../graphics/trap/spy_net.png', 'attack_type': 'speed'}
}